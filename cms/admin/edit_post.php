...
<body>
  <?php 
   ...
   <div class="col-lg-10">
    ...
    <?php
       ...
       $sql_edit = "SELECT * FROM posts WHERE id = $_GET[edit_id] ";
        $run_edit = mysqli_query($conn,$sql_edit);
        while($rows = mysqli_fetch_assoc($run_edit))
         ...
         <div class="page-header"><h2><?php echo $rows['title'];?></h2></div>
          <div class="container-fluid">
                   <form action="new_post.php" method="post" class="form-horizontal"  enctype="multipart/form-data">
                    <img src="../<?php echo $rows['image'];?>" width="150px;"  alt="">
          ...
          <div class="form-group">
              ...
              <input type="text" id="title" name="title" class="form-control" required  value="<?php echo $rows['title']?>">
          </div>
           ...
           <div class="form-group">
              ...
              <textarea name="description" id="description" cols="60" rows="6"  > <?php echo $rows['description']; ?></textarea>
          </div>
 ...
 <div class="form-group">
              <label for="submit" class="label-control">Edit</label>
